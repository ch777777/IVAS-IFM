...
from tikhub_sdk_v2.api import hybrid_parsing_api
from tikhub_sdk_v2.api import douyin_web_api_api
from tikhub_sdk_v2.api import tiktok_web_api_api
...
with ApiClient(configuration) as api_client:
    try:
        ...
        print("\n=== 测试混合解析API ===")
        try:
            hybrid_api = hybrid_parsing_api.HybridParsingApi(api_client)
        ...
        print("\n=== 测试抖音Web API ===")
        try:
            douyin_api = douyin_web_api_api.DouyinWebAPIApi(api_client)
        ...
        print("\n=== 测试TikTok Web API ===")
        try:
            tiktok_api = tiktok_web_api_api.TiktokWebAPIApi(api_client)
